...
device_id = 0
model_file="mm/mm_magicmind_models/yolov5m.qint8_mixed_float16.magicmind"
#model_file="mm/mm_magicmind_models/yolov5m.force_float16.magicmind"
...
def run(data,
    ...
    with mm.System() as mm_sys:
        ...
        for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
            ...
            out = torch.from_numpy(np.array(outputs[0].asnumpy()))
            dt[1] += time_sync() - t2
